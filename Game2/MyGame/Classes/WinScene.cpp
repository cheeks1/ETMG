...
bool WinScene::init()
{
    ...
    auto label = LabelTTF::create("Win Scene", "Arial", 24);
    ...
    //Main menu Button
    auto mainButton = MenuItemImage::create("mainButton.png", "mainButton.png", CC_CALLBACK_1(WinScene::MainMenuButtonCallback, this));
...
void WinScene::menuCloseCallback(Object* pSender)
{
...
void WinScene::MainMenuButtonCallback(Object* pSender)
{
