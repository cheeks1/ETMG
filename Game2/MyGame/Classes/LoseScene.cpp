...
bool LoseScene::init()
{
    ...
    auto label = LabelTTF::create("Lose Scene", "Arial", 24);
    ...
    //Main menu Button
    auto mainButton = MenuItemImage::create("mainButton.png", "mainButton.png", CC_CALLBACK_1(LoseScene::MainMenuButtonCallback, this));
...
void LoseScene::menuCloseCallback(Object* pSender)
{
...
void LoseScene::MainMenuButtonCallback(Object* pSender)
{
